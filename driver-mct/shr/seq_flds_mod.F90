...
contains
  ...
  subroutine seq_flds_set(nmlfile, ID, infodata)
    ...
    seq_flds_o2x_states_to_lnd = trim(o2x_states_to_lnd)  ! Dongyu
    ...
    if (seq_comm_iamroot(ID)) then
       ...
       write(logunit,*) subname//': seq_flds_o2x_states_to_lnd=',trim(seq_flds_o2x_states_to_lnd) ! Dongyu
       write(logunit,*) subname//': seq_flds_o2x_fluxes_to_lnd=',trim(seq_flds_o2x_fluxes_to_lnd)
    end if
