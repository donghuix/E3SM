module lnd2ocnType
  ...
  use seq_flds_mod  , only : lnd_ocn_two_way
  !
  ! !PUBLIC TYPES:
  implicit none
  private
  ...
  contains
    ...
    subroutine InitAllocate(this, bounds)
      !
      ! !DESCRIPTION:
      ! Initialize lnd2ocn derived type
      !
      ! !ARGUMENTS:
      class(lnd2ocn_type) :: this
      type(bounds_type), intent(in) :: bounds  
    ...
    subroutine Restart(this, bounds, ncid, flag)
      ...
      ! TODO: do we need restart for land ocean two way coupling?

    end subroutine Restart

end module lnd2ocnType